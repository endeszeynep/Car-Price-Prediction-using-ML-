...
visualizer = cv_scores(regressor, X_train, y_train, cv=folds, scoring='r2')
visualizer.fit(X_train,y_train)
visualizer.show()
...
#conda install -c districtdatalabs yellowbrick  KURULMASI GEREK
#score ların plotlanmış hali


"""

#özelliklerin önemini görmek için

viz = FeatureImportances(regressor)
viz.fit(X_train,y_train)
viz.show()
"""

"""
print("sütun sayısı:",len(X_train.columns))#44
hyper_params=[{"n_feature_to_select":list(range(1,40))}]
...
#print("estimator.get_params().keys():",rfe.get_params().keys())
...
plt.plot(X_train, regressor.predict(X_train[:,0]), color = 'green')
...
#K-FOLD İÇİN TEKRAR BAKILABİLİR
"""
...
#BU PLOTLAMA SONRA BAKARIMMM
#plot kısmı düzenlenmesi gerekiyor
"""
...
#benim ols daha iyi sonuç verdi bunu seçmiyoruzz
#BU LİNEAR REGRESSİON MODELİNİ KULLANMICAZ**KESİNLİKE BU DEĞİL EN KÖTÜ SONUCU VERDİ
"""
#r-squared:0.7327381482654167
